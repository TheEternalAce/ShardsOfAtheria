...
{
    public class HardlightSlash : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            int duration = 16 * 2; // Define the duration the projectile will exist in frames
            ...
            if (player.dead || player.ItemAnimationActive && player.HeldItem.type != ModContent.ItemType<ValkyrieBlade>()
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Color color26 = new Color(227, 182, 245, 80) * opacity;
