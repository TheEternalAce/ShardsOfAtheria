	...
	public class Genesis_Whip : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if (Projectile.alpha == 0)
			{
				...
				{
					Dust obj4 = Main.dust[Dust.NewDust(Projectile.position + Projectile.velocity * 2f, Projectile.width, Projectile.height, DustID.Torch, 0f, 0f, 100, default, 2f)];
					obj4.noGravity = true;
					obj4.velocity *= 2f;
				...
				float num73 = 18f;
				for (int num74 = 0; (float)num74 < num73; num74++)
				{
					if (Main.rand.NextBool(4))
					{
						Vector2 position = Projectile.position + Projectile.velocity + Projectile.velocity * ((float)num74 / num73);
						Dust obj5 = Main.dust[Dust.NewDust(position, Projectile.width, Projectile.height, DustID.Torch, 0f, 0f, 100, default)];
						obj5.noGravity = true;
						obj5.fadeIn = 0.5f;
