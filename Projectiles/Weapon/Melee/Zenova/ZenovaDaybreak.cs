...
{
    class ZenovaDaybreak : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Zenova Daybreak");
        }
		...
		public override void ModifyHitNPC(NPC target, ref int damage, ref float knockback, ref bool crit, ref int hitDirection)
		{
			...
			target.AddBuff(BuffID.Daybreak, 900); // Adds the ExampleJavelin debuff for a very small DoT
