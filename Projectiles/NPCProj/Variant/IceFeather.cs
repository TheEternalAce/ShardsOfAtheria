...
{
    public class IceFeather : ModProjectile
    {
        public override string Texture => "Terraria/Images/Item_" + ItemID.IceFeather;
        ...
        public override void Kill(int timeLeft)
        {
            for (int i = 0; i < 10; i++)
            {
                Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.Ice, Projectile.velocity.X * 0.1f, Projectile.velocity.Y * 0.1f, 0, default, 0.75f);
            }
        }
    }
}