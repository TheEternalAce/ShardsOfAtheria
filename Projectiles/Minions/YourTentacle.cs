...
namespace ShardsOfAtheria.Projectiles.Minions
{
    public class YourTentacle : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            const string ChainTexturePath = "ShardsOfAtheria/Projectiles/Minions/YourTentacleChain";
        ...
        public override void Kill(int timeLeft)
        {
            ...
            Gore.NewGore(Projectile.Center, new Vector2(Main.rand.Next(-6, 7), Main.rand.Next(-6, 7)), 388);
            Gore.NewGore(Projectile.Center, new Vector2(Main.rand.Next(-6, 7), Main.rand.Next(-6, 7)), 389);
        }
    }
}
