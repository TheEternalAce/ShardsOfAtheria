...
namespace ShardsOfAtheria.Projectiles.Summon.Minions
{
    public class TheHungry : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            Projectile.rotation = Vector2.Normalize(Projectile.Center - owner.Center).ToRotation() + MathHelper.PiOver2;
        ...
        {
            if (owner.dead || !owner.active || !owner.Slayer().WoFSoul)
                return false;
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            const string ChainTexturePath = "ShardsOfAtheria/Projectiles/Summon/Minions/TheHungryChain";
