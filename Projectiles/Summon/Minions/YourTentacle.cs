...
namespace ShardsOfAtheria.Projectiles.Summon.Minions
{
    public class YourTentacle : ModProjectile
    {
        ...
        {
            if (owner.dead || !owner.active || !owner.Slayer().PlanteraSoul)
                return false;
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            const string ChainTexturePath = "ShardsOfAtheria/Projectiles/Summon/Minions/YourTentacleChain";
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            Gore.NewGore(Projectile.GetSource_Death(), Projectile.position, new Vector2(Main.rand.Next(-6, 7), Main.rand.Next(-6, 7)), 389);
        }
    }
}
