...
namespace ShardsOfAtheria.Projectiles.Areus
{
    public class AreusHoloBannerProjector : ModProjectile
    {
        ...
        public override void Load()
        {
            if (Main.netMode == NetmodeID.Server)
                return;
            bannerTexture = ModContent.Request<Texture2D>("ShardsOfAtheria/Projectiles/Areus/AreusHoloBanner");
            projectionTexture = ModContent.Request<Texture2D>("ShardsOfAtheria/Projectiles/Areus/AreusHoloProjection");
        }
