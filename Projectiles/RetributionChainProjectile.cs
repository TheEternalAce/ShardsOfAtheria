...
{
	public class RetributionChainProjectile : ModProjectile
	{
		// The folder path to the flail chain sprite
		private const string ChainTexturePath = "SagesMania/Projectiles/RetributionChainProjectileChain";

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Retrubution Chain"); // Set the projectile name to Example Flail Ball
		}
