...
namespace ShardsOfAtheria.Projectiles.Melee.GenesisRagnarok
{
    public class RagnarokProj2 : ModProjectile
    {
        ...
        private const string ChainTexturePath = "ShardsOfAtheria/Projectiles/Melee/GenesisRagnarok/RagnarokProj2_GenesisChain";
        private const string AltChainTexturePath = "ShardsOfAtheria/Projectiles/Melee/GenesisRagnarok/RagnarokProj2_GenesisChain_Alt";
