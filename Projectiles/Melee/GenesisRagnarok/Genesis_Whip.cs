    ...
    public class Genesis_Whip : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            if (player.HeldItem.type == ModContent.ItemType<GenesisAndRagnarok>())
            {
                ...
                else if (upgrades == 5)
                {
                    ...
                    var explosion = Projectile.NewProjectileDirect(Projectile.GetSource_FromThis(), target.Center, Vector2.Zero,
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            if (num257 > 0f)
            {
                ...
                {
                    if (num257 - num258 < rectangle14.Height)
                    {
                    ...
                    num258 += rectangle14.Height * Projectile.scale;
