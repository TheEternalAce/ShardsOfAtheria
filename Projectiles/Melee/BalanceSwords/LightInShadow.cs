...
{
    public class LightInShadow : CoolSword
    {
        ...
        public override void UpdateSwing(float progress, float interpolatedSwingProgress)
        {
            ...
            if (progress == 0.5f && Main.myPlayer == Projectile.owner) FireProjectile(progress, ModContent.ProjectileType<LightBeam>(), (int)(Projectile.damage * 0.7f), 4f, 1f);
        }
        ...
        {
            DrawSwish();
            return SingleEdgeSwordDraw<LightWithinDarkness>(lightColor);
        }
    }
}