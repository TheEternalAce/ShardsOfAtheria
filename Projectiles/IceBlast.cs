        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
            ...
            if (projectile.owner == Main.myPlayer)
            {
                for (int i = 0; i < 3; i++)
                {
                    ...
                    Projectile.NewProjectile(projectile.position.X + speedX, projectile.position.Y + speedY, speedX, speedY, ModContent.ProjectileType<IceBoltGrav>(), (int)(projectile.damage * 0.5), 0f, projectile.owner, 0f, 0f);
                }
            }
