...
{
	public class OmegaChest : ModTile
	{
		...
		public override bool RightClick(int i, int j)
		{
			...
			else
			{
				if (isLocked)
				{
					...
					int key = ModContent.ItemType<OmegaKey>();
		...
		public override void MouseOver(int i, int j)
		{
			...
			else
			{
				...
				if (player.cursorItemIconText == "Omega Chest")
				{
					player.cursorItemIconID = ModContent.ItemType<OmegaChestItem>();
					if (Main.tile[left, top].TileFrameX / 36 == 1)
					{
						player.cursorItemIconID = ModContent.ItemType<OmegaKey>();
					}
