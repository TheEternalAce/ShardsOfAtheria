        ...
        public override void OnKill(NPC npc)
        {
            ...
            if (ModContent.GetInstance<SoAWorld>().slayerMode)
            {
                ...
                if (npc.type == NPCID.KingSlime)
                {
                    ...
                    {
                        // Normal mode
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.KingSlimeMask);
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.NinjaHood);
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.NinjaShirt);
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.NinjaPants);
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.SlimeGun);
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.SlimeHook);

                        // Expert mode
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.RoyalGel);

                        // Master mode
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.KingSlimePetItem);

                        // Slayer mode
                        //Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ModContent.ItemType<KingSoulCrystal>());
                        //Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ModContent.ItemType<SlimedKatana>());

                    }
                    Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.Solidifier, 4000);

                    Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.KingSlimeTrophy, 4000);
                    Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.KingSlimeMasterTrophy, 4000);
                }
                if (npc.type == NPCID.EyeofCthulhu)
                {
                    ...
                    for (int i = 0; i < numPlayers; i++)
                    {
                        ...
                        // Master mode
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.EyeOfCthulhuPetItem);
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.AviatorSunglasses);

                        // Slayer mode
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ModContent.ItemType<EyeSoulCrystal>());
                    ...
                    Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.EyeofCthulhuTrophy, 4000);
                    Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.EyeofCthulhuMasterTrophy, 4000);
                }
                if (npc.type == NPCID.BrainofCthulhu)
                {
                    ...
                    for (int i = 0; i < numPlayers; i++)
                    {
                        ...
                        // Expert mode
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.BrainOfConfusion);

                        // Master mode
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.BrainOfCthulhuPetItem);

                        // Slayer mode
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ModContent.ItemType<BrainSoulCrystal>());
                    ...
                    Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.BrainofCthulhuMasterTrophy, 4000);
                }
                if (npc.boss && System.Array.IndexOf(new int[] { NPCID.EaterofWorldsBody, NPCID.EaterofWorldsHead, NPCID.EaterofWorldsTail }, npc.type) > -1)
                {
                    ...
                    for (int i = 0; i < numPlayers; i++)
                    {
                        ...
                        // Master mode
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.EaterOfWorldsPetItem);

                        // Slayer mode
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ModContent.ItemType<EaterSoulCrystal>());
                    ...
                    Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.EaterofWorldsTrophy, 4000);
                    Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.EaterofWorldsMasterTrophy, 4000);
                }
                if (npc.type == NPCID.QueenBee)
                {
                    ...
                    for (int i = 0; i < numPlayers; i++)
                    {
                        ...
                        // Master mode
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.QueenBeePetItem);

                        // Slayer mode
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ModContent.ItemType<BeeSoulCrystal>());
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ModContent.ItemType<MarkOfAnastasia>());
                    }
                    Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.QueenBeeTrophy, 4000);
                    ...
                    Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.QueenBeeMasterTrophy, 4000);
                }
                if (npc.type == NPCID.SkeletronHead)
                {
                    ...
                    for (int i = 0; i < numPlayers; i++)
                    {
                        ...
                        // Master mode
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.SkeletronPetItem);

                        // Slayer mode
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ModContent.ItemType<SkullSoulCrystal>());
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ModContent.ItemType<VampiricJaw>());
                    }
                    Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.SkeletronTrophy, 4000);
                    Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.SkeletronMasterTrophy, 4000);
                }
                if (npc.type == NPCID.Deerclops)
                {
                    ...
                    {
                        // Normal mode
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.DeerclopsMask);
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.ChesterPetItem);
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.Eyebrella);
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.DontStarveShaderItem);
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.PewMaticHorn);
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.WeatherPain);
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.HoundiusShootius);
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.LucyTheAxe);

                        // Expert mode
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.BoneHelm);

                        // Master mode
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.DeerclopsPetItem);

                        // Slayer mode
                        //Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ModContent.ItemType<DeerclopsSoulCrystal>());
                        //Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ModContent.ItemType<>());

                    }

                    Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.DeerclopsTrophy, 4000);
                    Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.DeerclopsMasterTrophy, 4000);
                }
                if (npc.type == NPCID.WallofFlesh)
                {
                    ...
                    for (int i = 0; i < numPlayers; i++)
                    {
                        ...
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.BadgersHat);

                        // Expert Mode
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.DemonHeart);

                        // Master mode
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.WallOfFleshGoatMountItem);

                        // Slayer mode
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ModContent.ItemType<WallSoulCrystal>());
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ModContent.ItemType<FlailOfFlesh>());
                    }
                    Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.WallofFleshTrophy, 4000);
                    Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.WallofFleshMasterTrophy, 4000);
                }
                if (npc.type == NPCID.QueenSlimeBoss)
                {
                    ...
                    {
                        // Normal mode
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.QueenSlimeMask);
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.CrystalNinjaHelmet);
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.CrystalNinjaChestplate);
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.CrystalNinjaLeggings);
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.GelBalloon);
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.Smolstar);
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.QueenSlimeHook);
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.QueenSlimeMountSaddle);

                        // Expert mode
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.VolatileGelatin);

                        // Master mode
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.QueenSlimePetItem);

                        // Slayer mode
                        //Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ModContent.ItemType<QueenSoulCrystal>());
                        //Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ModContent.ItemType<>());

                    }

                    Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.QueenSlimeTrophy, 4000);
                    Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.QueenSlimeMasterTrophy, 4000);
                }
                if (npc.boss && System.Array.IndexOf(new int[] { NPCID.TheDestroyer, NPCID.TheDestroyerBody, NPCID.TheDestroyerTail }, npc.type) > -1)
                {
                    ...
                    for (int i = 0; i < numPlayers; i++)
                    {
                        ...
                        // Master mode
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.DestroyerPetItem);

                        // Slayer mode
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ModContent.ItemType<DestroyerSoulCrystal>());
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ModContent.ItemType<Coilgun>());
                    }
                    Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.SoulofMight, 4000);
                    Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.HallowedBar, 333);

                    Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.DestroyerTrophy, 4000);
                    Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.DestroyerMasterTrophy, 4000);
                }
                if (npc.boss && System.Array.IndexOf(new int[] { NPCID.Spazmatism, NPCID.Retinazer }, npc.type) > -1)
                {
                    ...
                    for (int i = 0; i < numPlayers; i++)
                    {
                        ...
                        // Master mode
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.TwinsPetItem);

                        // Slayer mode
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ModContent.ItemType<TwinsSoulCrystal>());
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ModContent.ItemType<DoubleBow>());
                    }
                    Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.SoulofSight, 4000);
                    Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.HallowedBar, 333);

                    Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.RetinazerTrophy, 4000);
                    Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.SpazmatismTrophy, 4000);
                    Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.TwinsMasterTrophy, 4000);
                }
                if (npc.type == NPCID.SkeletronPrime)
                {
                    ...
                    for (int i = 0; i < numPlayers; i++)
                    {
                        ...
                        // Master mode
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.SkeletronPrimePetItem);

                        // Slayer mode
                        //Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ModContent.ItemType<PrimeSoulCrystal>());
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ModContent.ItemType<BlasterCanonBlueprints>());
                    }
                    Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.SoulofFright, 4000);
                    Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.HallowedBar, 333);

                    Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.SkeletronPrimeTrophy, 4000);
                    Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.SkeletronPrimeMasterTrophy, 4000);
                }
                if (npc.type == NPCID.Plantera)
                {
                    ...
                    for (int i = 0; i < numPlayers; i++)
                    {
                        ...
                        // Master mode
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.PlanteraPetItem);

                        // Slayer mode
                        //Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ModContent.ItemType<PlantSoulCrystal>());
                    }
                    Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.PlanteraTrophy, 4000);
                    Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.PlanteraMasterTrophy, 4000);
                }
                if (npc.type == NPCID.Golem)
                {
                    ...
                    for (int i = 0; i < numPlayers; i++)
                    {
                        ...
                        // Master mode
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.GolemPetItem);

                        // Slayer mode
                        //Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ModContent.ItemType<GolemSoulCrystal>());
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ModContent.ItemType<SolarStorm>());
                    }
                    Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.BeetleHusk, 4000);
                    Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.StyngerBolt, 4000);

                    Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.GolemTrophy, 4000);
                    Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.GolemMasterTrophy, 4000);
                }
                if (npc.type == NPCID.DukeFishron)
                {
                    ...
                    for (int i = 0; i < numPlayers; i++)
                    {
                        ...
                        // Master mode
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.DukeFishronPetItem);

                        // Slayer mode
                        //Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ModContent.ItemType<DukeSoulCrystal>());
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ModContent.ItemType<HolyMackerel>());
                    }
                    Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.DukeFishronTrophy, 4000);
                    Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.DukeFishronMasterTrophy, 4000);
                }
                if (npc.type == 636)
                {
                    ...
                    {
                        // Normal mode
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.FairyQueenMask);
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.FairyQueenMagicItem);
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.PiercingStarlight);
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.RainbowWhip);
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.FairyQueenRangedItem);
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.RainbowWings);
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.SparkleGuitar);
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.RainbowCursor);
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.EmpressBlade);

                        // Expert mode
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.EmpressFlightBooster);

                        // Master mode
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.FairyQueenPetItem);

                        // Slayer mode
                        //Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ModContent.ItemType<EmpressSoulCrystal>());
                    }
                    Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.HallowBossDye, 4000);

                    Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.FairyQueenTrophy, 4000);
                    Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.FairyQueenMasterTrophy, 4000);
                }
                if (npc.type == NPCID.MoonLordCore)
                {
                    ...
                    for (int i = 0; i < numPlayers; i++)
                    {
                        ...
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.FireworksLauncher);
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.Celeb2);
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.MeowmereMinecart);

                        // Expert mode
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.GravityGlobe);

                        // Master mode
                        Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.MoonLordPetItem);

                        // Slayer mode
                        //Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ModContent.ItemType<LordSoulCrystal>());
                    }
                    Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.LunarOre, 4000);

                    Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.MoonLordTrophy, 4000);
                    Item.NewItem(npc.GetItemSource_Loot(), npc.getRect(), ItemID.MoonLordMasterTrophy, 4000);
                }
            }
