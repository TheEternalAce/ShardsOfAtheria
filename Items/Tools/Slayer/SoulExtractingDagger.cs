...
namespace ShardsOfAtheria.Items.Tools.Slayer
{
    public class SoulExtractingDagger : ModItem
    {
        ...
        public override void RightClick(Player player)
        {
            ...
            if (slayer.soulCrystalNames.Count == 0)
                CombatText.NewText(player.getRect(), Color.Blue, ShardsHelpers.LocalizeCommon("NoSoul"));
        ...
        {
            SoA.LogInfo(soulIndex, "Soul index to extract: ");
            SoA.LogInfo(player.Slayer().soulCrystalNames, "Old Soul Crystal list: ");
