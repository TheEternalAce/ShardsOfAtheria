...
namespace ShardsOfAtheria.Items.Weapons.Biochemical
{
    public class MythrilExtractor : ModItem
    {
        ...
        {
            Item.NewItem(target.GetItemSource_OnHit(target, ModContent.ItemType<MythrilExtractor>()), target.getRect(), ModContent.ItemType<UnanalyzedMicrobe>(), Main.rand.Next(20, 40));
        }
    }
}