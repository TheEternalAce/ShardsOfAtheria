...
namespace SagesMania.Items.Weapons
{
	public class TrueKnife : ModItem
	{
		...
		{
			DisplayName.SetDefault("True Kitchen Knife"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display name here by uncommenting this line.
