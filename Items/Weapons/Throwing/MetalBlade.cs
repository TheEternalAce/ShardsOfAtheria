...
namespace ShardsOfAtheria.Items.Weapons.Throwing
{
    public class MetalBlade : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.UseSound = ModContent.GetInstance<ShardsServerSideConfig>().metalBladeSound ? new SoundStyle($"{nameof(ShardsOfAtheria)}/Sounds/Item/MetalBlade") : SoundID.Item1;
            Item.noMelee = true;
