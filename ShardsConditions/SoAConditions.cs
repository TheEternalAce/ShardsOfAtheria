...
namespace ShardsOfAtheria.ShardsConditions
{
    public static class SoAConditions
    {
        ...
        //public static Condition NotDownedAndromeda = new("Mods.ShardsOfAtheria.Conditions.DownedAndromeda",
        //    () => !ShardsDownedSystem.downedCentipede);
        public static Condition DownedGenesis = new("Mods.ShardsOfAtheria.Conditions.DownedGenesis",
            () => ShardsDownedSystem.downedGenesis);
        public static Condition NotDownedGenesis = new("Mods.ShardsOfAtheria.Conditions.DownedGenesis",
            () => !ShardsDownedSystem.downedGenesis);
        ...
        public static Condition NotDownedSenterra = new("Mods.ShardsOfAtheria.Conditions.DownedSenterra",
            () => !ShardsDownedSystem.downedSenterra);
    }
}
