...
{
    internal class ComputerTextBox : UIPanel//UITextPanel<string>
    {
        private static readonly Asset<Texture2D> CloseButtonTexture = ModContent.Request<Texture2D>("Terraria/Images/UI/VK_Backspace");
        //private static readonly Asset<Texture2D> CloseButtonTexture = TextureAssets.Trash;
        ...
        public ComputerTextBox(string hintText, string text = "")
        {
            ...
            closeButton.Left.Set(-52, 1f);
            closeButton.Top.Set(-32f, 1f);
            closeButton.Width.Set(52, 0f);
            closeButton.Height.Set(26, 0f);
